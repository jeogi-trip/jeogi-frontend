    ...
    <div class="row">
      <div class="" style="width: 1200px; border: 3px solid lightgray; border-radius: 10px">
        <div class="form-head" style="margin: 20px">
          <br />
          <h4 class="title" style="font-size: 25px; font-family: 'neon'">공지 목록</h4>
          <br />
          <table style="font-size: 13px">
            ...
            <NoticeListItem v-for="article in articles" key="article.boardNo" :article="article"> </NoticeListItem>
